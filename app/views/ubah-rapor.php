											...
											<tr>
												...
												<td>
													<div class="col-sm-4">
														...
														<input type="text" class="form-control" name="nilai[<?=$data['kode_mapel']?>]" placeholder="Isi nilai" value="<?=$data['nilai']?>" required>
													</div>
												</td>
											</tr>
										<?php } ?>
						...
						<div class="row mt-3">
							...
							<div class="col-md-8">
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="col-sm-4">
													<input type="text" class="form-control" name="ijin" placeholder="Isi nilai" value="<?=$data_absen['ijin']?>" required>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="col-sm-4">
													<input type="text" class="form-control" name="sakit" placeholder="Isi nilai" required value="<?=$data_absen['sakit']?>">
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="col-sm-4">
													<input type="text" class="form-control" name="tanpa_keterangan" placeholder="Isi nilai" required value="<?=$data_absen['tanpa_keterangan']?>">
												</div>
											</td>
										</tr>
									</tbody>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9">
										<input type="date" class="form-control" name="tgl" placeholder="Alamat Lengkap Pengguna" required value="<?=$data_rapor['tgl_rapor']?>">
									</div>
								</div>
								<div class="row mb-3">
									<label for="inputEmail3" class="col-sm-2 col-form-label">Catatan</label>
									<div class="col-sm-9">
										<textarea class="form-control" name="catatan" placeholder="Catatan rapor / Catatan untuk siswa" rows="5"><?=$data_rapor['catatan_rapor']?></textarea>
									</div>
								</div>
								<div class="row">
									<div class="form-group row">
										<div class="col-sm-12 offset-sm-8">
											...
											<a href="?halaman=detail-rapor&nis=<?=$nis?>" class="btn btn-danger">Batal</a>											
										</div>
									</div>
								</div>
							</div>
